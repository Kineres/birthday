const contentLetterSrart_actived = "Happy Birthday Lê Đại Phúc Lâm 10 tuổi" //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc Lâm một ngày sinh nhật vui vẻ , khỏe mạnh ,học càng ngày càng giỏi hơn luôn nghe lời mẹ và chị nghen ." //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
// imgStart.src = "./img/cute-young-boy-kid-wearing-vest-and-hat-free-2png";
imgStart.src = "./img/phuclam.png";
